...
#define bombsPlayer 10 //default 16 /velocidad en que cambian los frames en la animacion de muerte, 16 significa que cuenta 16 veces el clockGames antes de pasar al siguiente frame
#define IMMUNE_EXPLOTION false //true para ser invulnerable a las explociones
...
//Bomba
#define STEPS_BOMB 80 //  Delay/Timer = #steps para tener el delay deseado antes de que explote la bomba
#define POT 20
