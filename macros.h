...
#define sizeMapX 39 //Solo numeros impares   Hay algunos numeros con los que no funciona poner bomba como con 31
#define sizeMapY 15 //Solo numeros impares
...
#define velPlayer 4  //Solo multiplos de 48
